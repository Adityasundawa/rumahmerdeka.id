    ...
    <div class="container">
        ...
        <div class="card mt-3 border-0 shadow-sm ">
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td class="text-end" rowspan="2">
                            <a href="{{url('')}}/bid-tanah" class="text-success fw-bold"
            ...
            <div class="card-body bg-card-dark-mode">
                            ...
                            <div class="col-12 custom ">
                                <div class="card mx-auto">
                                    ...
                                    <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Bidang BT-004 <img
                                        ...
                                        <div class="row g-0">
                                            <div class="col text-start">
                                                ...
                                                <a href="#" class="  mx-auto rounded-5" data-bs-toggle="modal"
                                                    data-bs-target="#modal-lihat-tanah" style="text-decoration:none">
                                ...
                                <div class="card mb-2 mx-auto">
                                    ...
                                    <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Bidang BT-001 <img
                                ...
                                <div class="card mb-2 mx-auto">
                                    ...
                                    <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Bidang BT-002 <img
                                                        src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1"
                                                        style="height:20px"></h5>
                                            </div>
                                        </div>
                                ...
                                <div class="card mb-2 mx-auto">
                                    ...
                                    <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Bidang BT-003 <img
                                                        src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1"
                                                        style="height:20px"></h5>
                                            </div>
                                        </div>
                ...
                <script>
                    $('#right-button-bid-tanah').click(function () {
                        event.preventDefault();
                    ...
                    $('#left-button-bid-tanah').click(function () {
                        event.preventDefault();
