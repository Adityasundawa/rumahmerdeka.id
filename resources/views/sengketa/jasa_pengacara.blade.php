        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <form action="{{url('')}}/daftar-jasa" method="get" id="form-pengacara">
                            <input type="hidden" name="title" value="Pengacara">
                        </form>
                        <a onclick="return $('form#form-pengacara').submit()" class="btn"
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a onclick="return $('form#form-pengacara').submit()"
                            ...
                            $.ajax({
                                ...
                                success: function (datas) {
                                    ...
                                    $('input[name=provinsi]').val($(
                                        'select#provinsi option:selected').text());
                                }
                            });
                        })
                            ...
                            $.ajax({
                                ...
                                success: function (datas) {
                                    ...
                                    $('input[name=kecamatan]').val($(
                                        'select#kecamatan option:selected').text());
                                }
                                                    ...
                                                    <table style="width:100%">
                                                        <tr>
                                                            <td rowspan="3">
                                                                ...
                                                                <img onclick="return  $('form#form-lawyer-<?= $i ?>').submit()"
                                                                    src="https://randomuser.me/api/portraits/men/{{$i}}.jpg"
                                                                    class="rounded-circle img-thumbnail "
                                                                    style="width:70px;height:auto;object-fit:cover;cursor: pointer;">
                                                            </td>
                                                            <td>
                                                                <b onclick="return  $('form#form-lawyer-<?= $i ?>').submit()"
