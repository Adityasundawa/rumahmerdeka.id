        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <form action="{{url('')}}/daftar-jasa" method="get" id="form-appraisal">
                            <input type="hidden" name="title" value="Appraisal">
                        </form>
                        <a onclick="return $('form#form-appraisal').submit()" class="btn"
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a onclick="return $('form#form-appraisal').submit()"
