                            ...
                            <div class="text-start">
                                ...
                                <ol style="padding-left: 1rem">
                                    ...
                                    <li>Mengintegrasikan semua jenis bidang seputar pertanahan dalam satu
                                        platform seperti sengketa pertanahan, jual beli tanah, kerja sama tanah
                                        sampai dengan pelelangan tanah.</li>
        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-2 mt-2 desktop">
                    ...
                    <div class="col-auto">
                        <a href="{{url('')}}/pilih-lob" class="btn"
                            style="background-color: #61481C; color: #fff">Daftar Sekarang</a>
                    </div>
                                                                ...
                                                                <g>
                                                                    <g>
                                                                        <path
                                                                            ...
                                                                            fill="#61481c" data-original="#000000"
                                                                            class="">
                                                                        </path>
                                                                        <path
                                                ...
                                                <g transform="matrix(0.7,0,0,0.7,76.80000457763674,76.81020755767824)">
                                                    <g id="Outline">
                                                        <path
                                                            ...
                                                            fill="#61481c" data-original="#000000" class=""></path>
                                                        <path
                                                            d="M300,136a12,12,0,1,0-12-12A12.013,12.013,0,0,0,300,136Z"
                                                            fill="#61481c" data-original="#000000" class=""></path>
                                                        <path
                                                            d="M372,136a12,12,0,1,0-12-12A12.013,12.013,0,0,0,372,136Z"
                                                            fill="#61481c" data-original="#000000" class=""></path>
                                                        <path
                ...
                <div class="row g-0">
                    <div class="col-auto ms-auto" style="margin-top:5px">
                        <div class="d-grid gap-2 me-1">
                            <a href="{{url('')}}/pilih-lob"
                                class="btn btn-sm btn-outline-brown rounded-5 fw-bold">Daftar Sekarang</a>
                        </div>
                    </div>
            ...
            <div class="modal-content border-0" style="background-color:transparent">
                ...
                <div class="modal-body d-flex" style="background-color:transparent">
                    <div class="container">
                        ...
                        <div id="carouselExampleIndicators" data-bs-touch="false" class="carousel slide mt-2 desktop"
                            data-bs-ride="false">
                        ...
                        <div id="carouselExampleIndicatorsM" data-bs-touch="false" class="carousel slide mt-2 mobile"
                            data-bs-ride="false">
                            ...
                            <div class="carousel-indicators custom scroll-simple">
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="0"
                                    class="active" aria-current="true" aria-label="Slide 1">
                                    <img src="{{asset('')}}images/lahan1.jpeg" class="d-block w-100" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="1"
                                    aria-label="Slide 2">
                                    <img src="{{asset('')}}images/lahan2.jpeg" class="d-block w-100" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="2"
                                    aria-label="Slide 3">
                                    <img src="{{asset('')}}images/lahan3.jpeg" class="d-block w-100" alt="...">
                                </button>
                                <button type="button" data-bs-target="#carouselExampleIndicatorsM" data-bs-slide-to="3"
                                    aria-label="Slide 4">
